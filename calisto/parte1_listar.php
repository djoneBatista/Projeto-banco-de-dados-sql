<?php
	...
	$tabela = $_GET["tabela"];
	$acao = "parte1_listar.php/?tabela=" . $tabela . "\"";
	...
	if ( !isset($_POST["fase2"]) ) {
		...
		echo "<!-- Tabela: " . $tabela . " -->\n";
		echo "<b>VALORES DAS CHAVES PRIMÁRIAS PARA BUSCA - TABELA \"" . $tabela . "\"</b><br />\n";
		echo "<hr>\n";
		echo "Por favor, informe os valores das chaves primárias para realizar a busca. Informe quantas desejar.<br />\n";
		echo "Caso deseje listar todas as linhas da tabela, deixe todos os campos em branco.<br />\n";
		echo "<form id=\"form_listar_fase1\" name=\"form_listar_fase1\" action=\"" . $acao . "\" method=\"post\">\n";
	...
	/* Depois de ter submetido os campos chave */
		...
		$sql_text = "CALL " . PACOTE1 . PROC_LISTAR . "(:ref_cursor, '" . $tabela . "', ";
		...
		echo "<!-- Tabela: " . $tabela . " -->\n";
		echo "<b>RESULTADO DA LISTAGEM - TABELA \"" . $tabela . "\"</b><br />\n";
		echo "<hr><br />\n";
		echo "<table border=\"1\">\n";
		while( $linha_detalhe = oci_fetch_row($sql_ref_cursor) ) {
			echo "	<tr>\n";
			for ( $i = 0; $i <= count($linha_detalhe)-1; $i++ ) {
				echo "		<td>\n";
				echo $linha_detalhe[$i];
				echo "		</td>\n";
			}
			echo "	</tr>\n";
		}
